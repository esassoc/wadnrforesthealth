...
export class FundSourceAllocationFileModalComponent extends BaseModal {
    ...
    constructor(
        ...
        this.filesControl.valueChanges.subscribe((files) => {
            ...
            // Remove entries whose file is no longer in the file list
    ...
    removeEntry(index: number): void {
        ...
        // Update the file control to stay in sync
    ...
    save(): void {
        ...
        const uploads = this.fileEntries.map(entry =>
            this.fundSourceAllocationService.uploadFileFundSourceAllocation(
