...
using WADNRForestHealthTracker.Common;
...
namespace WADNRForestHealthTracker.API.Services
{
    public class FileService
    {
        ...
        public async Task<FileResource> CreateFileResource(WADNRForestHealthTrackerDbContext dbContext, IFormFile file, int createUserID)
        {
        ...
        private async Task<FileResource> CreateFileResource(WADNRForestHealthTrackerDbContext dbContext, int createUserID,
        ...
        public async Task<FileResource> CreateFileResource(WADNRForestHealthTrackerDbContext dbContext, Stream stream, string fullFileName, int createUserID)
        {
