...
{
    private readonly WADNRConfiguration _WADNRConfiguration;
    ...
    public AzureBlobStorageService(IOptions<WADNRConfiguration> ltInfoConfiguration)
    {
        _WADNRConfiguration = ltInfoConfiguration.Value;
        // todo: use this container when pushing more fileresourcedata to blob
        //_fileResourceContainerClient = new BlobServiceClient(_WADNRConfiguration.AzureBlobStorageConnectionString).GetBlobContainerClient("WADNR-file-resource");
        _fileResourceContainerClient = new BlobServiceClient(_WADNRConfiguration.AzureBlobStorageConnectionString).GetBlobContainerClient("wadnr-file-resource");
    }
