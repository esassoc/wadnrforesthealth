...
interface EditFileModalInput {
    ...
    file: FileResourcePriorityLandscapeDetail;
}

@Component({
    selector: "priority-landscape-file-edit-modal",
    standalone: true,
...
export class PriorityLandscapeFileEditModalComponent extends BaseModal {
    ...
    save(): void {
        ...
        this.priorityLandscapeService.updateFileResourcePriorityLandscape(
            this.data.priorityLandscapeID,
            this.data.file.PriorityLandscapeFileResourceID!,
            {
