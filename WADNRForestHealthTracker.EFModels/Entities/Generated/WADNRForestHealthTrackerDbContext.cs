...
public partial class WADNRForestHealthTrackerDbContext : DbContext
{
    public WADNRForestHealthTrackerDbContext(DbContextOptions<WADNRForestHealthTrackerDbContext> options)
        : base(options)
    {
    }
