using WADNRForestHealthTracker.API.Logging;
using WADNRForestHealthTracker.API.Services;
using WADNRForestHealthTracker.API.Services.Filter;
using WADNRForestHealthTracker.Common.EMail;
using WADNRForestHealthTracker.Common.JsonConverters;
...
using WADNRForestHealthTracker.API.Hangfire;
using WADNRForestHealthTracker.API.Services.Middleware;
using ILogger = Serilog.ILogger;

namespace WADNRForestHealthTracker.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.Configure<WADNRForestHealthTrackerConfiguration>(Configuration);
            var configuration = Configuration.Get<WADNRForestHealthTrackerConfiguration>();
            ...
            services.AddDbContext<WADNRForestHealthTrackerDbContext>(c =>
            {
            ...
            services.AddScoped(s => UserContext.GetUserFromHttpContext(s.GetService<WADNRForestHealthTrackerDbContext>(), s.GetService<IHttpContextAccessor>().HttpContext));
            ...
            services.AddHealthChecks().AddDbContextCheck<WADNRForestHealthTrackerDbContext>();
        }
