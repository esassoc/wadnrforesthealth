...
export const routes: Routes = [
    ...
    // ProjectUpdate: Update approved project - all steps available
    {
        ...
        children: [
            { path: "", redirectTo: "basics", pathMatch: "full" },
            { path: "basics", loadComponent: () => import("./pages/projects/project-update-workflow/steps/basics/update-basics-step.component").then((m) => m.UpdateBasicsStepComponent) },
            { path: "location-simple", loadComponent: () => import("./pages/projects/project-update-workflow/steps/location-simple/update-location-simple-step.component").then((m) => m.UpdateLocationSimpleStepComponent) },
            { path: "location-detailed", loadComponent: () => import("./pages/projects/project-update-workflow/steps/location-detailed/update-location-detailed-step.component").then((m) => m.UpdateLocationDetailedStepComponent) },
            { path: "priority-landscapes", loadComponent: () => import("./pages/projects/project-update-workflow/steps/priority-landscapes/update-priority-landscapes-step.component").then((m) => m.UpdatePriorityLandscapesStepComponent) },
            { path: "dnr-upland-regions", loadComponent: () => import("./pages/projects/project-update-workflow/steps/dnr-upland-regions/update-dnr-upland-regions-step.component").then((m) => m.UpdateDnrUplandRegionsStepComponent) },
            { path: "counties", loadComponent: () => import("./pages/projects/project-update-workflow/steps/counties/update-counties-step.component").then((m) => m.UpdateCountiesStepComponent) },
            { path: "treatments", loadComponent: () => import("./pages/projects/project-update-workflow/steps/treatments/update-treatments-step.component").then((m) => m.UpdateTreatmentsStepComponent) },
            { path: "contacts", loadComponent: () => import("./pages/projects/project-update-workflow/steps/contacts/update-contacts-step.component").then((m) => m.UpdateContactsStepComponent) },
            { path: "organizations", loadComponent: () => import("./pages/projects/project-update-workflow/steps/organizations/update-organizations-step.component").then((m) => m.UpdateOrganizationsStepComponent) },
            { path: "expected-funding", loadComponent: () => import("./pages/projects/project-update-workflow/steps/expected-funding/update-expected-funding-step.component").then((m) => m.UpdateExpectedFundingStepComponent) },
            { path: "photos", loadComponent: () => import("./pages/projects/project-update-workflow/steps/photos/update-photos-step.component").then((m) => m.UpdatePhotosStepComponent) },
            { path: "external-links", loadComponent: () => import("./pages/projects/project-update-workflow/steps/external-links/update-external-links-step.component").then((m) => m.UpdateExternalLinksStepComponent) },
            { path: "documents-notes", loadComponent: () => import("./pages/projects/project-update-workflow/steps/documents-notes/update-documents-notes-step.component").then((m) => m.UpdateDocumentsNotesStepComponent) },
        ],
    },
    {
    ...
    { path: "reports", loadComponent: () => import("./shared/pages").then((m) => m.NotFoundComponent) },
    { path: "reports/projects", loadComponent: () => import("./shared/pages").then((m) => m.NotFoundComponent) },
