...
@Component({
    ...
    templateUrl: "./dnr-upland-regions-layer.component.html",
    styleUrls: ["./dnr-upland-regions-layer.component.scss"],
    imports: [GenericWmsWfsLayerComponent],
})
export class DNRUplandRegionsLayerComponent {
    /**
     * Overlay modes:
     ...
     */
    readonly WFS_FEATURE_TYPE = "WADNRForestHealth:DNRUplandRegion";
    readonly WMS_LAYER_NAME = "WADNRForestHealth:DNRUplandRegion";
    readonly IDENTIFIER_PROPERTY = "DNRUplandRegionID";
