...
(476, N'ProjectFundSourceAllocationRequestMatchAmount', N'DNR Match Amount', N'<p>The portion of the fund source allocation provided as match by WA DNR.</p>'),
(477, N'ProjectFundSourceAllocationRequestPayAmount', N'DNR Pay Amount', N'<p>The amount WA DNR has paid from this fund source allocation. Used to track grant expenditures and balances.</p>'),
...
when not matched by target then
    insert (FieldDefinitionID, FieldDefinitionName, FieldDefinitionDisplayName, DefaultDefinition)
    values (FieldDefinitionID, FieldDefinitionName, FieldDefinitionDisplayName, DefaultDefinition)
