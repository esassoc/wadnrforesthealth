...
@Component({
    selector: "priority-landscape-file-modal",
    standalone: true,
        ...
        <div class="modal">
            ...
            <div class="modal-body">
                ...
                <form-field
                    ...
                    [multiple]="true"
                    [uploadFileAccepts]="allowedExtensions">
                </form-field>
...
export class PriorityLandscapeFileModalComponent extends BaseModal {
    FormFieldType = FormFieldType;
    allowedExtensions = ".pdf,.zip,.doc,.docx,.xls,.xlsx,.ppt,.pptx,.txt,.jpg,.jpeg,.png";
    ...
    save(): void {
        ...
        const uploads = this.fileEntries.map(entry =>
            this.priorityLandscapeService.createFileResourcePriorityLandscape(
                this.data.priorityLandscapeID,
