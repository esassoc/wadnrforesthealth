...
@Component({
    selector: "priority-landscapes-step",
    standalone: true,
    ...
    templateUrl: "./priority-landscapes-step.component.html",
    styleUrls: ["./priority-landscapes-step.component.scss"],
})
export class PriorityLandscapesStepComponent extends CreateWorkflowStepBase implements OnInit {
    ...
    ngOnInit(): void {
        ...
        const stepData$ = this._projectID$.pipe(
            switchMap((id) => {
                ...
                return this.projectService.getCreatePriorityLandscapesStepProject(id).pipe(
                    catchError(() => {
    ...
    onSave(navigate: boolean): void {
        ...
        this.saveStep(
            (projectID) => this.projectService.saveCreatePriorityLandscapesStepProject(projectID, request),
