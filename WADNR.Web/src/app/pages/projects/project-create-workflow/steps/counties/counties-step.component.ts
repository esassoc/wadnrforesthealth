...
export class CountiesStepComponent extends CreateWorkflowStepBase implements OnInit {
    ...
    ngOnInit(): void {
        ...
        const stepData$ = this._projectID$.pipe(
            switchMap((id) => {
                ...
                return this.projectService.getCreateCountiesStepProject(id).pipe(
                    catchError(() => {
    ...
    handleMapLoad(event: WADNRMapInitEvent): void {
        ...
        // Add base layer showing all counties
    ...
    onSave(navigate: boolean): void {
        ...
        this.saveStep((projectID) => this.projectService.saveCreateCountiesStepProject(projectID, request), "Counties saved successfully.", "Failed to save counties.", navigate);
    }
}
