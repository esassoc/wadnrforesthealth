...
export class ProjectInternalNote { 
    readonly PrimaryKey?: number;
    ProjectInternalNoteID?: number;
    ProjectID?: number;
    Note?: string | null;
...
export interface ProjectInternalNoteForm { 
    PrimaryKey?: FormControl<number>;
    ProjectInternalNoteID?: FormControl<number>;
...
export class ProjectInternalNoteFormControls { 
    ...
    public static ProjectInternalNoteID = (value: FormControlState<number> | number = undefined, formControlOptions?: FormControlOptions | null) => new FormControl<number>(
        value,
        formControlOptions ?? 
        {
            nonNullable: false,
