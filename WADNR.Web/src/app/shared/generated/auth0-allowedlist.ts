...
const ANON_EXACT: ExactMap = {
  'DELETE': [],
  'GET': ["/","/agreement-statuses/lookup","/agreement-types/lookup","/agreements","/classification-systems","/classification-systems/lookup","/classification-systems/with-classifications","/classifications","/cost-share/generate-pdf","/counties","/custom-pages/menu-item","/dnr-upland-regions","/dnr-upland-regions/lookup","/external-map-layers/other-maps","/external-map-layers/priority-landscape","/external-map-layers/project-map","/federal-fund-codes/lookup","/find-your-forester/questions","/find-your-forester/roles","/firma-home-page-images","/fund-source-allocation-priorities/lookup","/fund-source-allocations","/fund-source-allocations/lookup","/fund-source-types/lookup","/fund-sources","/fund-sources/lookup","/funding-sources","/interactions-events","/invoices/approval-statuses","/organization-types","/organization-types/lookup","/organizations","/organizations/lead-implementers","/organizations/lookup","/organizations/lookup-with-short-name","/priority-landscapes","/priority-landscapes/categories","/program-indices","/program-indices/lookup","/program-indices/search","/programs","/project-codes","/project-codes/lookup","/project-codes/search","/project-documents/types","/project-images/timings","/project-person-relationship-types","/project-types","/project-types/lookup","/projects","/projects/featured","/projects/mapped-point/feature-collection","/projects/no-simple-location","/relationship-types","/relationship-types/lookup","/relationship-types/summary","/tags","/taxonomy-branches","/taxonomy-branches/lookup","/taxonomy-trunks","/taxonomy-trunks/lookup","/with-project-count"],
  'POST': ["/sitkacapture/generate-pdf"],
  'PUT': [],
};

const SECURED_EXACT: ExactMap = {
  'DELETE': [],
  'GET': ["/agreements/excel-download","/api/Job/import-history","/custom-pages","/custom-rich-texts","/external-map-layers","/field-definitions","/find-your-forester/assignable-people","/focus-areas","/focus-areas/locations","/fund-sources/excel-download","/gis-bulk-import/source-organizations","/invoices","/loa-upload/dashboard","/people","/people/lookup","/people/lookup/wadnr","/people/stewardship-areas/regions","/programs/eligible-editors","/project-types/taxonomy","/project-update-configurations","/projects/excel-download","/projects/lookup","/projects/no-contact-count","/projects/pending","/projects/pending/excel-download","/projects/people-receiving-reminders","/projects/update-status","/report-templates","/report-templates/models","/roles","/vendors","/vendors/excel-download","/vendors/search"],
