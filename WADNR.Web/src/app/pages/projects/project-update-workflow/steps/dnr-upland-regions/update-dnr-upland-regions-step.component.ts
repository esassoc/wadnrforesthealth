...
export class UpdateDnrUplandRegionsStepComponent extends UpdateWorkflowStepBase implements OnInit {
    readonly nextStep = "counties";
    readonly stepKey = "DnrUplandRegions";
    ...
    ngOnInit(): void {
        ...
        const stepData$ = this.stepRefresh$.pipe(
            switchMap((id) => {
                ...
                return this.projectService.getUpdateDnrUplandRegionsStepProject(id).pipe(
                    catchError(() => {
    ...
    onSave(navigate: boolean): void {
        ...
        this.saveStep(
            (projectID) => this.projectService.saveUpdateDnrUplandRegionsStepProject(projectID, request),
