...
public class AzureStorage(IOptions<WADNRForestHealthTrackerConfiguration> apiConfiguration, ILogger<AzureStorage> logger)
    : IAzureStorage
{
    #region Dependency Injection / Constructor

    private readonly string _storageConnectionString = apiConfiguration.Value.AzureBlobStorageConnectionString;
