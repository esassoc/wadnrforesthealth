...
//        {
//            var urlTemplate = $"/SampleController/SampleAction/{UrlTemplate.Parameter1Int}/{UrlTemplate.Parameter2String}";
...
//        {
//            var urlTemplate = $"/SampleController/SampleAction/{UrlTemplate.Parameter1Int}/{UrlTemplate.Parameter2String}/{UrlTemplate.Parameter3Int}";
...
//            Assert.That(() => new UrlTemplate<int, string>($"/SampleController/SampleAction/{UrlTemplate.Parameter1Int}/{UrlTemplate.Parameter1String}"), Throws.Exception, "Should error if there's two of the same ordinals");
//        }
//    }
//}
