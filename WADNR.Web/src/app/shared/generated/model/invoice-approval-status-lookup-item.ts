...
export class InvoiceApprovalStatusLookupItem { 
...
export interface InvoiceApprovalStatusLookupItemForm { 
    InvoiceApprovalStatusID?: FormControl<number>;
    InvoiceApprovalStatusName?: FormControl<string>;
}

export class InvoiceApprovalStatusLookupItemFormControls { 
