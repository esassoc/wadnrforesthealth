...
{
    private readonly WADNRForestHealthTrackerConfiguration _wadnrForestHealthTrackerConfiguration;
    ...
    public AzureBlobStorageService(IOptions<WADNRForestHealthTrackerConfiguration> ltInfoConfiguration)
    {
        _wadnrForestHealthTrackerConfiguration = ltInfoConfiguration.Value;
        // todo: use this container when pushing more fileresourcedata to blob
        //_fileResourceContainerClient = new BlobServiceClient(_wadnrForestHealthTrackerConfiguration.AzureBlobStorageConnectionString).GetBlobContainerClient("wadnrForestHealthTracker-file-resource");
        _fileResourceContainerClient = new BlobServiceClient(_wadnrForestHealthTrackerConfiguration.AzureBlobStorageConnectionString).GetBlobContainerClient("wadnr-file-resource");
    }
    ...
    {
        return await DownloadBlobFromBlobStorage(fileResource.FileResourceGUID.ToString().ToLower());
    }
