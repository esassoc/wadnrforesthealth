...
using WADNRForestHealthTracker.Common.Views;
...
namespace WADNRForestHealthTracker.Common
{
    public static class StringFormats
    {
        ...
        public static string ToStringPercent(this double? value)
        {
        ...
        {
            return d.HasValue ? ToIntString(d.Value) : "";
        }
        ...
        public static string ToStringShortPercent(this double value)
        {
            return value.ToString("0%");
        }
        ...
        public static string ToStringShortPercent(this decimal? value)
        {
            return value.HasValue ? value.Value.ToStringShortPercent() : "";
        }
        ...
        public static string ToStringPercentOneDecimal(this int value)
        {
            return value.ToString("0.0%");
        }

        public static string ToStringPercentOneDecimal(this decimal value)
        {
            return value.ToString("0.0%");
        }

        public static string ToStringPercentOneDecimal(this double value)
        {
            return value.ToString("0.0%");
        }
        ...
        public static string ToStringPercentOneDecimal(this double? value)
        {
            return value.HasValue ? value.Value.ToStringPercentOneDecimal() : "";
        }
        ...
        public static string ToNotProvidedIfNull(this string value)
        {
            ...
            {
                return $"<span class='systemText'>{value.ToProperCase()} {ViewUtilities.NotProvidedString}</span>";
            }
            return value;
        }
        ...
        public static string ToStringCurrencyBillions(this decimal value)
        {
            return value.ToString("0,,,.#B", CultureInfo.InvariantCulture);
        }

        public static string ToStringCurrencyAccounting(this decimal value)
        {
            return value >= 0 ? value.ToStringCurrencyFull() : "(" + Math.Abs(value).ToStringCurrencyFull() + ")";
        }
        public static decimal? ParseNullableDecimalFromCurrencyString(string currencyString)
        {
            ...
            {
                throw new ApplicationException($"Could not parse currency value \"{currencyString}\"");
            }
        ...
        public static string ToStringDate(this DateTime? dateTime, bool twoDigitYear)
        {
            ...
            return dateTime?.ToString(formatString) ?? String.Empty;
        }
        ...
        public static string ToStringDateTime(this DateTime? dateTime)
        {
            return dateTime?.ToString("MM/dd/yyyy h:mm tt") ?? String.Empty;
        }
        ...
        public static string ToStringDateTimeNoLeadingZeros(this DateTime? dateTime)
        {
            return dateTime?.ToString("M/d/yyyy h:mm tt") ?? String.Empty;
        }
        ...
        //public static readonly Regex ContainAbsoluteUrlWithApplicationDomainReferenceRegEx = new Regex(ConstructContainAbsoluteUrlWithApplicationDomainReferenceRegExForApplicationDomain(WADNRForestHealthTrackerWebConfiguration.ApplicationDomain), RegexOptions.IgnoreCase | RegexOptions.Multiline);

        private static Regex GetContainAbsoluteUrlWithApplicationDomainReferenceRegEx(string applicationDomain)
        {
            return new Regex(ConstructContainAbsoluteUrlWithApplicationDomainReferenceRegExForApplicationDomain(applicationDomain), RegexOptions.IgnoreCase | RegexOptions.Multiline);
        }
        ...
        /// <returns></returns>
        public static bool DoesHtmlStringContainAbsoluteUrlWithApplicationDomainReference(this string htmlString, string applicationDomain)
        {
        ...
        /// <summary>
        /// Takes a list of numbers and returns a string of the consecutive number ranges. I.e. [1,2,3,5,6,8,10,11,12] => "1 - 3, 5 - 6, 8, 10 - 12"
        /// </summary>
        /// <param name="numbers"></param>
        /// <returns></returns>
        public static string ToRangeString(this List<int> numbers)
        {
            ...
            var ranges = new[] {new[] {numbers[0], numbers[0]}}.ToList();
            var lastIndex = 0;

            for (var i = 1; i < numbers.Count; i++)
            {
                if (numbers[i] - ranges[lastIndex][1] == 1)
                {
                    ranges[lastIndex][1] = numbers[i];
                }
                else
                {
                    lastIndex++;
                    ranges.Add(new[] { numbers[i], numbers[i] });
                }
            }
            return string.Join(", ", ranges.Select(x => string.Join(" - ", x.Distinct())));
        }
    }
}
