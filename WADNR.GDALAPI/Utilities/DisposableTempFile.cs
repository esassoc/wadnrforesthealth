...
public class DisposableTempFile : IDisposable
{
    ...
    public DisposableTempFile() : this(Path.GetTempFileName()) { }
    ...
    public FileInfo FileInfo
    {
        get
        {
            if (_isDisposed) throw new ObjectDisposedException(nameof(DisposableTempFile));
            return _fileInfo!;
        }
    }
