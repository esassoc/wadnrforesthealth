...
export class DynamicEnvironment {
    ...
    public get mainSiteUrl() {
        return window.config.mainSiteUrl;
    }

    // number of projects completed prior to 2007 that are not represented in project-level data
    public get pre2007ProjectCount() {
        return window.config.pre2007ProjectCount ?? 0;
    }
}
