...
@Component({
    selector: "interaction-event-file-modal",
    standalone: true,
...
export class InteractionEventFileModalComponent extends BaseModal {
    ...
    save(): void {
        ...
        const uploads = this.fileEntries.map(entry =>
            this.interactionEventService.createFileResourceInteractionEvent(
