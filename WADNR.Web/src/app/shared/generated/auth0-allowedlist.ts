...
const SECURED_EXACT: ExactMap = {
  'DELETE': [],
  'GET': ["/agreements","/agreements/excel-download","/api/Job/import-history","/custom-pages","/custom-rich-texts","/external-map-layers","/field-definitions","/find-your-forester/assignable-people","/focus-areas","/focus-areas/locations","/fund-sources/excel-download","/gis-bulk-import/source-organizations","/invoices","/loa-upload/dashboard","/people","/people/lookup","/people/lookup/wadnr","/people/stewardship-areas/regions","/programs/eligible-editors","/project-update-configurations","/projects/excel-download","/projects/lookup","/projects/no-contact-count","/projects/pending","/projects/pending/excel-download","/projects/people-receiving-reminders","/projects/update-status","/report-templates","/report-templates/models","/roles","/vendors","/vendors/excel-download","/vendors/search"],
