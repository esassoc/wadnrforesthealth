...
{
    public static async Task<List<ProgramGridRow>> ListAsGridRowAsync(WADNRForestHealthTrackerDbContext dbContext)
    {
    ...
    public static async Task<ProgramDetail?> GetByIDAsDetailAsync(WADNRForestHealthTrackerDbContext dbContext, int programID)
    {
    ...
    public static async Task<ProgramDetail?> CreateAsync(WADNRForestHealthTrackerDbContext dbContext, ProgramUpsertRequest dto, int callingPersonID)
    {
    ...
    public static async Task<ProgramDetail?> UpdateAsync(WADNRForestHealthTrackerDbContext dbContext, int programID, ProgramUpsertRequest dto, int callingPersonID)
    {
    ...
    public static async Task<bool> DeleteAsync(WADNRForestHealthTrackerDbContext dbContext, int programID)
    {
