...
// @ts-ignore
import { CustomNotificationRequest } from '../model/custom-notification-request';
// @ts-ignore
...
// @ts-ignore
import { FeaturedProjectsUpdateRequest } from '../model/featured-projects-update-request';
// @ts-ignore
...
// @ts-ignore
import { MapExtentSaveRequest } from '../model/map-extent-save-request';
// @ts-ignore
import { MapExtentStep } from '../model/map-extent-step';
// @ts-ignore
import { PendingProjectGridRow } from '../model/pending-project-grid-row';
// @ts-ignore
import { PeopleReceivingReminderGridRow } from '../model/people-receiving-reminder-grid-row';
// @ts-ignore
import { ProjectAuditLogGridRow } from '../model/project-audit-log-grid-row';
// @ts-ignore
import { ProjectBasicsEditData } from '../model/project-basics-edit-data';
// @ts-ignore
import { ProjectBasicsSaveRequest } from '../model/project-basics-save-request';
// @ts-ignore
...
// @ts-ignore
import { ProjectClassificationDetailItem } from '../model/project-classification-detail-item';
// @ts-ignore
import { ProjectClassificationSaveRequest } from '../model/project-classification-save-request';
// @ts-ignore
...
// @ts-ignore
import { ProjectFeatured } from '../model/project-featured';
// @ts-ignore
import { ProjectFundingDetail } from '../model/project-funding-detail';
// @ts-ignore
import { ProjectFundingSaveRequest } from '../model/project-funding-save-request';
// @ts-ignore
...
// @ts-ignore
import { ProjectInternalNoteGridRow } from '../model/project-internal-note-grid-row';
// @ts-ignore
...
// @ts-ignore
import { ProjectNoteUpsertRequest } from '../model/project-note-upsert-request';
// @ts-ignore
...
// @ts-ignore
import { ProjectTagSaveRequest } from '../model/project-tag-save-request';
// @ts-ignore
...
// @ts-ignore
import { ProjectUpdateBatchDetail } from '../model/project-update-batch-detail';
// @ts-ignore
...
// @ts-ignore
import { ProjectUpdateHistoryEntry } from '../model/project-update-history-entry';
// @ts-ignore
...
// @ts-ignore
import { ProjectUpdateStatusGridRow } from '../model/project-update-status-grid-row';
// @ts-ignore
...
// @ts-ignore
import { TagLookupItem } from '../model/tag-lookup-item';
// @ts-ignore
...
export class ProjectService extends BaseService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public approveGdbForDirectEditProject(projectID: number, gdbApproveRequest?: GdbApproveRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<LocationDetailedStep>;
    public approveGdbForDirectEditProject(projectID: number, gdbApproveRequest?: GdbApproveRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<LocationDetailedStep>>;
    public approveGdbForDirectEditProject(projectID: number, gdbApproveRequest?: GdbApproveRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<LocationDetailedStep>>;
    public approveGdbForDirectEditProject(projectID: number, gdbApproveRequest?: GdbApproveRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling approveGdbForDirectEditProject.');
        }
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/location-detailed/approve-gdb`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<LocationDetailedStep>('post', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public createUpdateDocumentProject(projectID: number, displayName?: string, description?: string, projectDocumentTypeID?: number, file?: Blob, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public createUpdateDocumentProject(projectID: number, displayName?: string, description?: string, projectDocumentTypeID?: number, file?: Blob, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public createUpdateDocumentProject(projectID: number, displayName?: string, description?: string, projectDocumentTypeID?: number, file?: Blob, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public createUpdateDocumentProject(projectID: number, displayName?: string, description?: string, projectDocumentTypeID?: number, file?: Blob, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling createUpdateDocumentProject.');
        }
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/update-workflow/steps/documents-notes/documents`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<any>('post', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
    ...
    /**
     * @param projectID 
     * @param projectNoteUpsertRequest 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public createUpdateNoteProject(projectID: number, projectNoteUpsertRequest?: ProjectNoteUpsertRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public createUpdateNoteProject(projectID: number, projectNoteUpsertRequest?: ProjectNoteUpsertRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public createUpdateNoteProject(projectID: number, projectNoteUpsertRequest?: ProjectNoteUpsertRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public createUpdateNoteProject(projectID: number, projectNoteUpsertRequest?: ProjectNoteUpsertRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling createUpdateNoteProject.');
        }
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/update-workflow/steps/documents-notes/notes`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<any>('post', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                body: projectNoteUpsertRequest,
                responseType: <any>responseType_,
                ...(withCredentials ? { withCredentials } : {}),
                headers: localVarHeaders,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public createUpdatePhotoImageProject(projectID: number, caption?: string, credit?: string, projectImageTimingID?: number, excludeFromFactSheet?: boolean, file?: Blob, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public createUpdatePhotoImageProject(projectID: number, caption?: string, credit?: string, projectImageTimingID?: number, excludeFromFactSheet?: boolean, file?: Blob, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public createUpdatePhotoImageProject(projectID: number, caption?: string, credit?: string, projectImageTimingID?: number, excludeFromFactSheet?: boolean, file?: Blob, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public createUpdatePhotoImageProject(projectID: number, caption?: string, credit?: string, projectImageTimingID?: number, excludeFromFactSheet?: boolean, file?: Blob, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling createUpdatePhotoImageProject.');
        }
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/update-workflow/steps/photos/images`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<any>('post', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
    ...
    /**
     * @param projectID 
     * @param projectDocumentUpdateID 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public deleteUpdateDocumentProject(projectID: number, projectDocumentUpdateID: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public deleteUpdateDocumentProject(projectID: number, projectDocumentUpdateID: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public deleteUpdateDocumentProject(projectID: number, projectDocumentUpdateID: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public deleteUpdateDocumentProject(projectID: number, projectDocumentUpdateID: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling deleteUpdateDocumentProject.');
        }
        if (projectDocumentUpdateID === null || projectDocumentUpdateID === undefined) {
            throw new Error('Required parameter projectDocumentUpdateID was null or undefined when calling deleteUpdateDocumentProject.');
        }
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/update-workflow/steps/documents-notes/documents/${this.configuration.encodeParam({name: "projectDocumentUpdateID", value: projectDocumentUpdateID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<any>('delete', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
    ...
    /**
     * @param projectID 
     * @param projectNoteUpdateID 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public deleteUpdateNoteProject(projectID: number, projectNoteUpdateID: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public deleteUpdateNoteProject(projectID: number, projectNoteUpdateID: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public deleteUpdateNoteProject(projectID: number, projectNoteUpdateID: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public deleteUpdateNoteProject(projectID: number, projectNoteUpdateID: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling deleteUpdateNoteProject.');
        }
        if (projectNoteUpdateID === null || projectNoteUpdateID === undefined) {
            throw new Error('Required parameter projectNoteUpdateID was null or undefined when calling deleteUpdateNoteProject.');
        }
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/update-workflow/steps/documents-notes/notes/${this.configuration.encodeParam({name: "projectNoteUpdateID", value: projectNoteUpdateID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<any>('delete', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
    ...
    /**
     * @param projectID 
     * @param projectImageUpdateID 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public deleteUpdatePhotoImageProject(projectID: number, projectImageUpdateID: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public deleteUpdatePhotoImageProject(projectID: number, projectImageUpdateID: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public deleteUpdatePhotoImageProject(projectID: number, projectImageUpdateID: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public deleteUpdatePhotoImageProject(projectID: number, projectImageUpdateID: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling deleteUpdatePhotoImageProject.');
        }
        if (projectImageUpdateID === null || projectImageUpdateID === undefined) {
            throw new Error('Required parameter projectImageUpdateID was null or undefined when calling deleteUpdatePhotoImageProject.');
        }
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/update-workflow/steps/photos/images/${this.configuration.encodeParam({name: "projectImageUpdateID", value: projectImageUpdateID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<any>('delete', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public excelDownloadProject(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public excelDownloadProject(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public excelDownloadProject(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public excelDownloadProject(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/projects/excel-download`;
        const { basePath, withCredentials } = this.configuration;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getAsMapPopupHtmlProject(projectID: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public getAsMapPopupHtmlProject(projectID: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public getAsMapPopupHtmlProject(projectID: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public getAsMapPopupHtmlProject(projectID: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling getAsMapPopupHtmlProject.');
        }
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/map-popup-html`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<any>('get', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getBasicsEditDataProject(projectID: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<ProjectBasicsEditData>;
    public getBasicsEditDataProject(projectID: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<ProjectBasicsEditData>>;
    public getBasicsEditDataProject(projectID: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<ProjectBasicsEditData>>;
    public getBasicsEditDataProject(projectID: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling getBasicsEditDataProject.');
        }
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/basics/edit`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<ProjectBasicsEditData>('get', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                ...(withCredentials ? { withCredentials } : {}),
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getCountiesProject(projectID: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<GeographicAssignmentStep>;
    public getCountiesProject(projectID: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<GeographicAssignmentStep>>;
    public getCountiesProject(projectID: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<GeographicAssignmentStep>>;
    public getCountiesProject(projectID: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling getCountiesProject.');
        }
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/counties`;
        const { basePath, withCredentials } = this.configuration;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getCurrentUpdateBatchProject(projectID: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<ProjectUpdateBatchDetail>;
    public getCurrentUpdateBatchProject(projectID: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<ProjectUpdateBatchDetail>>;
    public getCurrentUpdateBatchProject(projectID: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<ProjectUpdateBatchDetail>>;
    public getCurrentUpdateBatchProject(projectID: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/update-workflow/current`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<ProjectUpdateBatchDetail>('get', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                ...(withCredentials ? { withCredentials } : {}),
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getDnrUplandRegionsProject(projectID: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<GeographicAssignmentStep>;
    public getDnrUplandRegionsProject(projectID: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<GeographicAssignmentStep>>;
    public getDnrUplandRegionsProject(projectID: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<GeographicAssignmentStep>>;
    public getDnrUplandRegionsProject(projectID: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling getDnrUplandRegionsProject.');
        }
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/dnr-upland-regions`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<GeographicAssignmentStep>('get', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getFundingProject(projectID: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<ProjectFundingDetail>;
    public getFundingProject(projectID: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<ProjectFundingDetail>>;
    public getFundingProject(projectID: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<ProjectFundingDetail>>;
    public getFundingProject(projectID: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling getFundingProject.');
        }
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/funding`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<ProjectFundingDetail>('get', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                ...(withCredentials ? { withCredentials } : {}),
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getLocationDetailedProject(projectID: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<LocationDetailedStep>;
    public getLocationDetailedProject(projectID: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<LocationDetailedStep>>;
    public getLocationDetailedProject(projectID: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<LocationDetailedStep>>;
    public getLocationDetailedProject(projectID: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling getLocationDetailedProject.');
        }
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/location-detailed`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<LocationDetailedStep>('get', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getLocationSimpleProject(projectID: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<LocationSimpleStep>;
    public getLocationSimpleProject(projectID: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<LocationSimpleStep>>;
    public getLocationSimpleProject(projectID: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<LocationSimpleStep>>;
    public getLocationSimpleProject(projectID: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling getLocationSimpleProject.');
        }
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/location-simple`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<LocationSimpleStep>('get', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getMapExtentProject(projectID: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<MapExtentStep>;
    public getMapExtentProject(projectID: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<MapExtentStep>>;
    public getMapExtentProject(projectID: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<MapExtentStep>>;
    public getMapExtentProject(projectID: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling getMapExtentProject.');
        }
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/map-extent`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<MapExtentStep>('get', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                ...(withCredentials ? { withCredentials } : {}),
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getNoContactCountProject(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<number>;
    public getNoContactCountProject(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<number>>;
    public getNoContactCountProject(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<number>>;
    public getNoContactCountProject(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/projects/no-contact-count`;
        const { basePath, withCredentials } = this.configuration;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getPriorityLandscapesProject(projectID: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<GeographicAssignmentStep>;
    public getPriorityLandscapesProject(projectID: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<GeographicAssignmentStep>>;
    public getPriorityLandscapesProject(projectID: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<GeographicAssignmentStep>>;
    public getPriorityLandscapesProject(projectID: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling getPriorityLandscapesProject.');
        }
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/priority-landscapes`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<GeographicAssignmentStep>('get', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
    ...
    /**
     * @param projectID 
     * @param projectUpdateBatchID 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public getUpdateHistoryDiffProject(projectID: number, projectUpdateBatchID: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<ProjectUpdateDiffSummary>;
    public getUpdateHistoryDiffProject(projectID: number, projectUpdateBatchID: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<ProjectUpdateDiffSummary>>;
    public getUpdateHistoryDiffProject(projectID: number, projectUpdateBatchID: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<ProjectUpdateDiffSummary>>;
    public getUpdateHistoryDiffProject(projectID: number, projectUpdateBatchID: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling getUpdateHistoryDiffProject.');
        }
        if (projectUpdateBatchID === null || projectUpdateBatchID === undefined) {
            throw new Error('Required parameter projectUpdateBatchID was null or undefined when calling getUpdateHistoryDiffProject.');
        }
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/update-history/${this.configuration.encodeParam({name: "projectUpdateBatchID", value: projectUpdateBatchID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/diff`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<ProjectUpdateDiffSummary>('get', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listClassificationsForEditProject(projectID: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<Array<ProjectClassificationDetailItem>>;
    public listClassificationsForEditProject(projectID: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Array<ProjectClassificationDetailItem>>>;
    public listClassificationsForEditProject(projectID: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<ProjectClassificationDetailItem>>>;
    public listClassificationsForEditProject(projectID: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling listClassificationsForEditProject.');
        }
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/classifications/edit`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<Array<ProjectClassificationDetailItem>>('get', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                ...(withCredentials ? { withCredentials } : {}),
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listClassificationsProject(projectID: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<Array<ProjectClassificationDetailItem>>;
    public listClassificationsProject(projectID: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Array<ProjectClassificationDetailItem>>>;
    public listClassificationsProject(projectID: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<ProjectClassificationDetailItem>>>;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listFeaturedProject(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<Array<ProjectFeatured>>;
    public listFeaturedProject(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Array<ProjectFeatured>>>;
    public listFeaturedProject(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<ProjectFeatured>>>;
    public listFeaturedProject(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/projects/featured`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<Array<ProjectFeatured>>('get', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                ...(withCredentials ? { withCredentials } : {}),
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listInternalNotesProject(projectID: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<Array<ProjectInternalNoteGridRow>>;
    public listInternalNotesProject(projectID: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Array<ProjectInternalNoteGridRow>>>;
    public listInternalNotesProject(projectID: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<ProjectInternalNoteGridRow>>>;
    public listInternalNotesProject(projectID: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling listInternalNotesProject.');
        }
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/internal-notes`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<Array<ProjectInternalNoteGridRow>>('get', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                ...(withCredentials ? { withCredentials } : {}),
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listInvoicePaymentRequestsProject(projectID: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<Array<InvoicePaymentRequestGridRow>>;
    public listInvoicePaymentRequestsProject(projectID: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Array<InvoicePaymentRequestGridRow>>>;
    public listInvoicePaymentRequestsProject(projectID: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<InvoicePaymentRequestGridRow>>>;
    public listInvoicePaymentRequestsProject(projectID: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling listInvoicePaymentRequestsProject.');
        }
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/invoice-payment-requests`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<Array<InvoicePaymentRequestGridRow>>('get', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                ...(withCredentials ? { withCredentials } : {}),
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listInvoicesProject(projectID: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<Array<InvoiceGridRow>>;
    public listInvoicesProject(projectID: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Array<InvoiceGridRow>>>;
    public listInvoicesProject(projectID: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<InvoiceGridRow>>>;
    public listInvoicesProject(projectID: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling listInvoicesProject.');
        }
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/invoices`;
        const { basePath, withCredentials } = this.configuration;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listLookupProject(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<Array<ProjectLookupItem>>;
    public listLookupProject(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Array<ProjectLookupItem>>>;
    public listLookupProject(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<ProjectLookupItem>>>;
    public listLookupProject(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/projects/lookup`;
        const { basePath, withCredentials } = this.configuration;
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listPendingProject(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<Array<PendingProjectGridRow>>;
    public listPendingProject(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Array<PendingProjectGridRow>>>;
    public listPendingProject(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<PendingProjectGridRow>>>;
    public listPendingProject(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/projects/pending`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<Array<PendingProjectGridRow>>('get', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                ...(withCredentials ? { withCredentials } : {}),
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listPeopleReceivingRemindersProject(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<Array<PeopleReceivingReminderGridRow>>;
    public listPeopleReceivingRemindersProject(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Array<PeopleReceivingReminderGridRow>>>;
    public listPeopleReceivingRemindersProject(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<PeopleReceivingReminderGridRow>>>;
    public listPeopleReceivingRemindersProject(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/projects/people-receiving-reminders`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<Array<PeopleReceivingReminderGridRow>>('get', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                ...(withCredentials ? { withCredentials } : {}),
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listUpdateBatchHistoryProject(projectID: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<Array<ProjectUpdateHistoryEntry>>;
    public listUpdateBatchHistoryProject(projectID: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Array<ProjectUpdateHistoryEntry>>>;
    public listUpdateBatchHistoryProject(projectID: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<ProjectUpdateHistoryEntry>>>;
    public listUpdateBatchHistoryProject(projectID: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling listUpdateBatchHistoryProject.');
        }
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/update-workflow/history`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<Array<ProjectUpdateHistoryEntry>>('get', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                ...(withCredentials ? { withCredentials } : {}),
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listUpdateStatusProject(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<Array<ProjectUpdateStatusGridRow>>;
    public listUpdateStatusProject(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Array<ProjectUpdateStatusGridRow>>>;
    public listUpdateStatusProject(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<ProjectUpdateStatusGridRow>>>;
    public listUpdateStatusProject(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/projects/update-status`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<Array<ProjectUpdateStatusGridRow>>('get', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                ...(withCredentials ? { withCredentials } : {}),
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public pendingExcelDownloadProject(observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public pendingExcelDownloadProject(observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public pendingExcelDownloadProject(observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public pendingExcelDownloadProject(observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/projects/pending/excel-download`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<any>('get', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
    ...
    /**
     * @param projectID 
     * @param projectClassificationSaveRequest 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public saveAllClassificationsProject(projectID: number, projectClassificationSaveRequest?: ProjectClassificationSaveRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<Array<ProjectClassificationDetailItem>>;
    public saveAllClassificationsProject(projectID: number, projectClassificationSaveRequest?: ProjectClassificationSaveRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Array<ProjectClassificationDetailItem>>>;
    public saveAllClassificationsProject(projectID: number, projectClassificationSaveRequest?: ProjectClassificationSaveRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<ProjectClassificationDetailItem>>>;
    public saveAllClassificationsProject(projectID: number, projectClassificationSaveRequest?: ProjectClassificationSaveRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling saveAllClassificationsProject.');
        }
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/classifications`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<Array<ProjectClassificationDetailItem>>('put', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                body: projectClassificationSaveRequest,
                responseType: <any>responseType_,
                ...(withCredentials ? { withCredentials } : {}),
                headers: localVarHeaders,
                observe: observe,
    ...
    /**
     * @param projectID 
     * @param projectTagSaveRequest 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public saveAllTagsProject(projectID: number, projectTagSaveRequest?: ProjectTagSaveRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<Array<TagLookupItem>>;
    public saveAllTagsProject(projectID: number, projectTagSaveRequest?: ProjectTagSaveRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Array<TagLookupItem>>>;
    public saveAllTagsProject(projectID: number, projectTagSaveRequest?: ProjectTagSaveRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<TagLookupItem>>>;
    public saveAllTagsProject(projectID: number, projectTagSaveRequest?: ProjectTagSaveRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling saveAllTagsProject.');
        }
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/tags`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<Array<TagLookupItem>>('put', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                body: projectTagSaveRequest,
                responseType: <any>responseType_,
                ...(withCredentials ? { withCredentials } : {}),
                headers: localVarHeaders,
                observe: observe,
    ...
    /**
     * @param projectID 
     * @param projectBasicsSaveRequest 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public saveBasicsProject(projectID: number, projectBasicsSaveRequest?: ProjectBasicsSaveRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public saveBasicsProject(projectID: number, projectBasicsSaveRequest?: ProjectBasicsSaveRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public saveBasicsProject(projectID: number, projectBasicsSaveRequest?: ProjectBasicsSaveRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public saveBasicsProject(projectID: number, projectBasicsSaveRequest?: ProjectBasicsSaveRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling saveBasicsProject.');
        }
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/basics`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<any>('put', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                body: projectBasicsSaveRequest,
                responseType: <any>responseType_,
                ...(withCredentials ? { withCredentials } : {}),
                headers: localVarHeaders,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public saveCountiesProject(projectID: number, geographicOverrideRequest?: GeographicOverrideRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<GeographicAssignmentStep>;
    public saveCountiesProject(projectID: number, geographicOverrideRequest?: GeographicOverrideRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<GeographicAssignmentStep>>;
    public saveCountiesProject(projectID: number, geographicOverrideRequest?: GeographicOverrideRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<GeographicAssignmentStep>>;
    public saveCountiesProject(projectID: number, geographicOverrideRequest?: GeographicOverrideRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling saveCountiesProject.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public saveDnrUplandRegionsProject(projectID: number, geographicOverrideRequest?: GeographicOverrideRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<GeographicAssignmentStep>;
    public saveDnrUplandRegionsProject(projectID: number, geographicOverrideRequest?: GeographicOverrideRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<GeographicAssignmentStep>>;
    public saveDnrUplandRegionsProject(projectID: number, geographicOverrideRequest?: GeographicOverrideRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<GeographicAssignmentStep>>;
    public saveDnrUplandRegionsProject(projectID: number, geographicOverrideRequest?: GeographicOverrideRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling saveDnrUplandRegionsProject.');
        }
    ...
    /**
     * @param projectID 
     * @param projectFundingSaveRequest 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public saveFundingProject(projectID: number, projectFundingSaveRequest?: ProjectFundingSaveRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<ProjectFundingDetail>;
    public saveFundingProject(projectID: number, projectFundingSaveRequest?: ProjectFundingSaveRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<ProjectFundingDetail>>;
    public saveFundingProject(projectID: number, projectFundingSaveRequest?: ProjectFundingSaveRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<ProjectFundingDetail>>;
    public saveFundingProject(projectID: number, projectFundingSaveRequest?: ProjectFundingSaveRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling saveFundingProject.');
        }
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/funding`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<ProjectFundingDetail>('put', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                body: projectFundingSaveRequest,
                responseType: <any>responseType_,
                ...(withCredentials ? { withCredentials } : {}),
                headers: localVarHeaders,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public saveLocationDetailedProject(projectID: number, locationDetailedStepRequest?: LocationDetailedStepRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<LocationDetailedStep>;
    public saveLocationDetailedProject(projectID: number, locationDetailedStepRequest?: LocationDetailedStepRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<LocationDetailedStep>>;
    public saveLocationDetailedProject(projectID: number, locationDetailedStepRequest?: LocationDetailedStepRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<LocationDetailedStep>>;
    public saveLocationDetailedProject(projectID: number, locationDetailedStepRequest?: LocationDetailedStepRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling saveLocationDetailedProject.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public saveLocationSimpleProject(projectID: number, locationSimpleStepRequest?: LocationSimpleStepRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<LocationSimpleStep>;
    public saveLocationSimpleProject(projectID: number, locationSimpleStepRequest?: LocationSimpleStepRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<LocationSimpleStep>>;
    public saveLocationSimpleProject(projectID: number, locationSimpleStepRequest?: LocationSimpleStepRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<LocationSimpleStep>>;
    public saveLocationSimpleProject(projectID: number, locationSimpleStepRequest?: LocationSimpleStepRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling saveLocationSimpleProject.');
        }
    ...
    /**
     * @param projectID 
     * @param mapExtentSaveRequest 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public saveMapExtentProject(projectID: number, mapExtentSaveRequest?: MapExtentSaveRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public saveMapExtentProject(projectID: number, mapExtentSaveRequest?: MapExtentSaveRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public saveMapExtentProject(projectID: number, mapExtentSaveRequest?: MapExtentSaveRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public saveMapExtentProject(projectID: number, mapExtentSaveRequest?: MapExtentSaveRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling saveMapExtentProject.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public savePriorityLandscapesProject(projectID: number, geographicOverrideRequest?: GeographicOverrideRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<GeographicAssignmentStep>;
    public savePriorityLandscapesProject(projectID: number, geographicOverrideRequest?: GeographicOverrideRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<GeographicAssignmentStep>>;
    public savePriorityLandscapesProject(projectID: number, geographicOverrideRequest?: GeographicOverrideRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<GeographicAssignmentStep>>;
    public savePriorityLandscapesProject(projectID: number, geographicOverrideRequest?: GeographicOverrideRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling savePriorityLandscapesProject.');
        }
    ...
    /**
     * @param customNotificationRequest 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public sendCustomNotificationProject(customNotificationRequest?: CustomNotificationRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public sendCustomNotificationProject(customNotificationRequest?: CustomNotificationRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public sendCustomNotificationProject(customNotificationRequest?: CustomNotificationRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public sendCustomNotificationProject(customNotificationRequest?: CustomNotificationRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/projects/send-custom-notification`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<any>('post', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public sendPreviewNotificationProject(customNotificationRequest?: CustomNotificationRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public sendPreviewNotificationProject(customNotificationRequest?: CustomNotificationRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public sendPreviewNotificationProject(customNotificationRequest?: CustomNotificationRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public sendPreviewNotificationProject(customNotificationRequest?: CustomNotificationRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/projects/send-preview-notification`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<any>('post', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public setKeyPhotoUpdatePhotoProject(projectID: number, projectImageUpdateID: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public setKeyPhotoUpdatePhotoProject(projectID: number, projectImageUpdateID: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public setKeyPhotoUpdatePhotoProject(projectID: number, projectImageUpdateID: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public setKeyPhotoUpdatePhotoProject(projectID: number, projectImageUpdateID: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling setKeyPhotoUpdatePhotoProject.');
        }
        if (projectImageUpdateID === null || projectImageUpdateID === undefined) {
            throw new Error('Required parameter projectImageUpdateID was null or undefined when calling setKeyPhotoUpdatePhotoProject.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public startUpdateBatchProject(projectID: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<ProjectUpdateBatchDetail>;
    public startUpdateBatchProject(projectID: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<ProjectUpdateBatchDetail>>;
    public startUpdateBatchProject(projectID: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<ProjectUpdateBatchDetail>>;
    public startUpdateBatchProject(projectID: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<ProjectUpdateBatchDetail>('post', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                ...(withCredentials ? { withCredentials } : {}),
    ...
    /**
     * @param featuredProjectsUpdateRequest 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public updateFeaturedProject(featuredProjectsUpdateRequest?: FeaturedProjectsUpdateRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public updateFeaturedProject(featuredProjectsUpdateRequest?: FeaturedProjectsUpdateRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public updateFeaturedProject(featuredProjectsUpdateRequest?: FeaturedProjectsUpdateRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public updateFeaturedProject(featuredProjectsUpdateRequest?: FeaturedProjectsUpdateRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        return this.httpClient.request<any>('put', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                body: featuredProjectsUpdateRequest,
                responseType: <any>responseType_,
                ...(withCredentials ? { withCredentials } : {}),
                headers: localVarHeaders,
                observe: observe,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateUpdateDocumentProject(projectID: number, projectDocumentUpdateID: number, projectDocumentUpsertRequest?: ProjectDocumentUpsertRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public updateUpdateDocumentProject(projectID: number, projectDocumentUpdateID: number, projectDocumentUpsertRequest?: ProjectDocumentUpsertRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public updateUpdateDocumentProject(projectID: number, projectDocumentUpdateID: number, projectDocumentUpsertRequest?: ProjectDocumentUpsertRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public updateUpdateDocumentProject(projectID: number, projectDocumentUpdateID: number, projectDocumentUpsertRequest?: ProjectDocumentUpsertRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling updateUpdateDocumentProject.');
        }
        if (projectDocumentUpdateID === null || projectDocumentUpdateID === undefined) {
            throw new Error('Required parameter projectDocumentUpdateID was null or undefined when calling updateUpdateDocumentProject.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateUpdateNoteProject(projectID: number, projectNoteUpdateID: number, projectNoteUpsertRequest?: ProjectNoteUpsertRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public updateUpdateNoteProject(projectID: number, projectNoteUpdateID: number, projectNoteUpsertRequest?: ProjectNoteUpsertRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public updateUpdateNoteProject(projectID: number, projectNoteUpdateID: number, projectNoteUpsertRequest?: ProjectNoteUpsertRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public updateUpdateNoteProject(projectID: number, projectNoteUpdateID: number, projectNoteUpsertRequest?: ProjectNoteUpsertRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling updateUpdateNoteProject.');
        }
        if (projectNoteUpdateID === null || projectNoteUpdateID === undefined) {
            throw new Error('Required parameter projectNoteUpdateID was null or undefined when calling updateUpdateNoteProject.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateUpdatePhotoImageProject(projectID: number, projectImageUpdateID: number, projectImageUpsertRequest?: ProjectImageUpsertRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any>;
    public updateUpdatePhotoImageProject(projectID: number, projectImageUpdateID: number, projectImageUpsertRequest?: ProjectImageUpsertRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<any>>;
    public updateUpdatePhotoImageProject(projectID: number, projectImageUpdateID: number, projectImageUpsertRequest?: ProjectImageUpsertRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<any>>;
    public updateUpdatePhotoImageProject(projectID: number, projectImageUpdateID: number, projectImageUpsertRequest?: ProjectImageUpsertRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: undefined, context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling updateUpdatePhotoImageProject.');
        }
        if (projectImageUpdateID === null || projectImageUpdateID === undefined) {
            throw new Error('Required parameter projectImageUpdateID was null or undefined when calling updateUpdatePhotoImageProject.');
        }
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public uploadGdbForDirectEditProject(projectID: number, file?: Blob, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<Array<GdbFeatureClassPreview>>;
    public uploadGdbForDirectEditProject(projectID: number, file?: Blob, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Array<GdbFeatureClassPreview>>>;
    public uploadGdbForDirectEditProject(projectID: number, file?: Blob, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<GdbFeatureClassPreview>>>;
    public uploadGdbForDirectEditProject(projectID: number, file?: Blob, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'text/plain' | 'application/json' | 'text/json', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (projectID === null || projectID === undefined) {
            throw new Error('Required parameter projectID was null or undefined when calling uploadGdbForDirectEditProject.');
        }
        ...
        let localVarPath = `/projects/${this.configuration.encodeParam({name: "projectID", value: projectID, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int32"})}/location-detailed/upload-gdb`;
        const { basePath, withCredentials } = this.configuration;
        return this.httpClient.request<Array<GdbFeatureClassPreview>>('post', `${basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
