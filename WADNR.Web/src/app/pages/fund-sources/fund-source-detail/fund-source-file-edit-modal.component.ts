...
interface EditFileModalInput {
    fundSourceID: number;
    file: FundSourceFileResourceGridRow;
}

@Component({
    selector: "fund-source-file-edit-modal",
    standalone: true,
...
export class FundSourceFileEditModalComponent extends BaseModal {
    ...
    save(): void {
        ...
        this.fundSourceService.updateFileFundSource(
            this.data.fundSourceID,
            this.data.file.FundSourceFileResourceID!,
            {
