...
namespace WADNR.EFModels.Entities
{
    public abstract partial class FieldDefinition : IHavePrimaryKey
    {
        ...
        public static readonly FieldDefinitionIsUser IsUser = FieldDefinitionIsUser.Instance;
        ...
        public List<ProjectPersonRelationshipType> ProjectPersonRelationshipTypes => ProjectPersonRelationshipType.All.Where(x => x.FieldDefinitionID == FieldDefinitionID).ToList();
        [Key]
        ...
        public FieldDefinitionEnum ToEnum => (FieldDefinitionEnum)GetHashCode();
        ...
        public static FieldDefinition ToType(FieldDefinitionEnum enumValue)
        {
            switch (enumValue)
            {
                ...
                case FieldDefinitionEnum.IsUser:
                    return IsUser;
    ...
    public partial class FieldDefinitionIsUser : FieldDefinition
    {
        private FieldDefinitionIsUser(int fieldDefinitionID, string fieldDefinitionName, string fieldDefinitionDisplayName, string defaultDefinition) : base(fieldDefinitionID, fieldDefinitionName, fieldDefinitionDisplayName, defaultDefinition) {}
        public static readonly FieldDefinitionIsUser Instance = new FieldDefinitionIsUser(536, @"IsUser", @"Is User", @"Indicates whether this person is a registered user who can log in and be assigned roles, or a contact-only record.");
    }
}