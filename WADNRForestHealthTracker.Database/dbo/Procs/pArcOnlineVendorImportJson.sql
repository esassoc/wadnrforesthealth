...
EMAIL: null
	*/
        ...
        VENDOR_NUMBER varchar(256),
        VENDOR_NUMBER_SUFFIX varchar(256),
        ...
        ZIP_PLUS_4 varchar(256),
        PHONE_NUMBER varchar(200),
        VENDOR_STATUS varchar(256),
        VENDOR_TYPE varchar(256),
        BILLING_AGENCY varchar(256),
        BILLING_SUBAGENCY varchar(256),
        BILLING_FUND varchar(256),
        BILLING_FUND_BREAKOUT varchar(256),
        CCD_CTX_FLAG varchar(256),
