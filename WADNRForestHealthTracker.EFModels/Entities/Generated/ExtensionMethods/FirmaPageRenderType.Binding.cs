...
namespace WADNRForestHealthTracker.EFModels.Entities
{
    public abstract partial class FirmaPageRenderType : IHavePrimaryKey
    {
        ...
        public List<FirmaPageType> FirmaPageTypes => FirmaPageType.All.Where(x => x.FirmaPageRenderTypeID == FirmaPageRenderTypeID).ToList();
        [Key]
        ...
        public FirmaPageRenderTypeEnum ToEnum => (FirmaPageRenderTypeEnum)GetHashCode();
