CREATE TABLE [dbo].[FundSourceAllocationExpenditureJsonStage](
    [FundSourceAllocationExpenditureJsonStageID] [int] IDENTITY(1,1) NOT NULL CONSTRAINT [PK_FundSourceAllocationExpenditureJsonStage_FundSourceAllocationExpenditureJsonStageID] PRIMARY KEY,
    [Biennium] [int] NULL,
    [FiscalMo] [int] NULL,
